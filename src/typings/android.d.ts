declare namespace com {
    export namespace paytm {
        export namespace pgsdk {
...
declare namespace com {
    export namespace paytm {
        export namespace pgsdk {
            export class IntentServicePostNotification {
                public callHttp(param0: string): void;
                public onHandleIntent(param0: androidcontentIntent): void;
                public constructor();
            }
        }
    }
...
declare namespace com {
    export namespace paytm {
        export namespace pgsdk {
            export class IntentServicePreNotification {
                public callHttp(param0: string): void;
                public onHandleIntent(param0: androidcontentIntent): void;
                public constructor();
            }
    ...
    export namespace paytm {
        export namespace pgsdk {
            export class PaytmOrder {
                ...
                public getRequestParamMap(): javautilMap<string, string>;
            }
        }
    }
}
    ...
    export namespace paytm {
        export namespace pgsdk {
            export class PaytmPGActivity {
                ...
                public onKeyDown(
                    param0: number,
                    param1: androidviewKeyEvent
                ): boolean;
                public constructor();
            }
            export namespace PaytmPGActivity {
    ...
    export namespace paytm {
        export namespace pgsdk {
            export class PaytmPGService {
                ...
                public initialize(
                    param0: com.paytm.pgsdk.PaytmOrder,
                    param1: com.paytm.pgsdk.PaytmClientCertificate
                ): void;
                public startPaymentTransaction(
                    param0: androidcontentContext,
                    param1: boolean,
                    param2: boolean,
                    param3: com.paytm.pgsdk.PaytmPaymentTransactionCallback
                ): void;
    ...
    export namespace paytm {
        export namespace pgsdk {
            export class PaytmSSLSocketFactory {
                ...
                public createSocket(
                    param0: javanetSocket,
                    param1: string,
                    param2: number,
                    param3: boolean
                ): javanetSocket;
                public createSocket(
                    param0: javanetInetAddress,
                    param1: number,
                    param2: javanetInetAddress,
                    param3: number
                ): javanetSocket;
    ...
    export namespace paytm {
        export namespace pgsdk {
            export class PaytmUtility {
                public static getURLEncodedJSONString(
                    param0: androidosBundle
                ): string;
                public static debugLog(param0: string): void;
                public static printStackTrace(param0: javalangException): void;
                public static getStringFromBundle(
                    param0: androidosBundle
                ): string;
                public static isNetworkAvailable(
                    param0: androidcontentContext
                ): boolean;
                public static getURLEncodedStringFromBundle(
                    param0: androidosBundle
                ): string;
            ...
            export namespace PaytmWebView {
                ...
                export class PaytmWebViewClient {
                    public onReceivedError(
                        param0: androidwebkitWebView,
                        param1: number,
                        param2: string,
                        param3: string
                    ): void;
                    public onReceivedSslError(
                        param0: androidwebkitWebView,
                        param1: androidwebkitSslErrorHandler,
                        param2: androidnethttpSslError
                    ): void;
                    public onPageStarted(
                        param0: androidwebkitWebView,
                        param1: string,
                        param2: androidgraphicsBitmap
                    ): void;
