	...
	export module paytm {
		export module pgsdk {
			export class PaytmPGService {
				...
				public initialize(param0: com.paytm.pgsdk.PaytmOrder, param1: com.paytm.pgsdk.PaytmClientCertificate): void;
		...
		export module pgsdk {
			export class PaytmPaymentTransactionCallback {
				...
				public constructor(implementation: {
					...
					onTransactionCancel(param0: string, param1: androidosBundle): void;
				});
				public networkNotAvailable(): void;
				public onTransactionCancel(param0: string, param1: androidosBundle): void;
